      ...
      <div className="report-header">        
          <Row className="crl">
            <Col md={12}>
             ...
             <h5 className="text-center pio"> CI : {this.props.data.ci}</h5>
            ...
            <Table className="table-reporteh mt-2">
              <tbody>
                  ...
                  <tr><td><b>Nombres :</b></td>
                      <td>{this.props.data.nombres}</td>
                  </tr>
                  <tr><td><b>Apellido Paterno :</b></td>
                      <td>{this.props.data.paterno}</td>
                  </tr>
                  <tr><td><b>Apellido Materno :</b></td>
                      <td>{this.props.data.materno}</td>
                  </tr>
